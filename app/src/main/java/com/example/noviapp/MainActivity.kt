...
import com.example.noviapp.presentation.ChatScreen
...
fun NoviAIUI(navController: NavController) {
    ...
    Box(
        ...
        LazyColumn(
            ...
            item { CultureVoScreen(navController) }
...
fun CultureVoScreen(navController: NavController) {
    Column(
        ...
        Box(
            modifier = Modifier
                .background(Color(0xFF202020), shape = RoundedCornerShape(12.dp))
                .padding(12.dp)
        ) {
            Text(
